  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-800 text-white">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 -left-40 h-96 w-96 rounded-full bg-green-600/10 blur-3xl" />
        <div className="absolute top-1/3 -right-40 h-96 w-96 rounded-full bg-emerald-600/10 blur-3xl" />
      ...
      <section className="relative container mx-auto px-6 pt-20 pb-32">
        <div className="max-w-5xl mx-auto text-center stagger-item">
      ...
      <section className="relative container mx-auto px-6 pb-24">
        <div className="max-w-4xl mx-auto">
          <Card className="liquid-glass bg-white/5 backdrop-blur-sm border-white/10 stagger-item">
            <CardContent className="p-12">
              <div className="mb-8">
                <h2 className="text-2xl md:text-3xl font-bold tracking-tighter mb-6">Our Story: From Success to Breaking Point (and Back)</h2>
                <div className="space-y-6 text-slate-300 leading-relaxed">
                  <div className="bg-gradient-to-r from-green-500/20 to-emerald-500/20 rounded-lg p-6 border border-green-400/30 stagger-item">
                  ...
                  <div className="bg-gradient-to-r from-red-500/20 to-orange-500/20 rounded-lg p-6 border border-red-400/30 stagger-item">
      ...
      <section className="relative container mx-auto px-6 pb-24">
        <div className="grid md:grid-cols-5 gap-8 max-w-6xl mx-auto">
          <Card className="liquid-glass md:col-span-3 bg-gradient-to-br from-green-600/10 to-green-600/5 backdrop-blur-sm border-green-500/20 hover:border-green-500/40 transition-all stagger-item">
            <CardContent className="p-10">
              <div className="w-14 h-14 rounded-xl bg-green-600/20 flex items-center justify-center mb-6">
                <Target className="w-7 h-7 text-green-400" />
              </div>
              <h3 className="text-2xl md:text-3xl font-bold tracking-tighter mb-4">Our Mission</h3>
              <p className="text-slate-300 text-lg leading-relaxed">
                Help entrepreneurs <span className="text-green-400 font-semibold">scale themselves</span> so they can 
                <span className="text-green-400 font-semibold">scale their companies</span>. Because stronger founders 
                create better teams, healthier families, and thriving economies.
              </p>
            </CardContent>
          </Card>

          <Card className="liquid-glass md:col-span-2 bg-gradient-to-br from-emerald-600/10 to-emerald-600/5 backdrop-blur-sm border-emerald-500/20 hover:border-emerald-500/40 transition-all stagger-item">
            <CardContent className="p-10">
              <div className="w-14 h-14 rounded-xl bg-emerald-600/20 flex items-center justify-center mb-6">
                <Lightbulb className="w-7 h-7 text-emerald-400" />
              </div>
              <h3 className="text-2xl md:text-3xl font-bold tracking-tighter mb-4">Our Vision</h3>
              <p className="text-slate-300 text-lg leading-relaxed">
      ...
      {/* Core Values */}
      <section className="relative container mx-auto px-6 pb-24">
        <div className="max-w-4xl mx-auto text-center mb-16 stagger-item">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
          <Card className="liquid-glass bg-white/5 backdrop-blur-sm border-white/10 hover:border-white/20 transition-all group stagger-item">
            <CardContent className="p-8 text-center">
              ...
              <h3 className="text-lg font-bold tracking-tight mb-3">Clarity Over Complexity</h3>
          ...
          <Card className="liquid-glass bg-white/5 backdrop-blur-sm border-white/10 hover:border-white/20 transition-all group stagger-item">
            <CardContent className="p-8 text-center">
              <div className="w-14 h-14 rounded-full bg-emerald-600/20 flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform">
                <Heart className="w-7 h-7 text-emerald-400" />
              </div>
              <h3 className="text-lg font-bold tracking-tight mb-3">User-First Always</h3>
              <p className="text-slate-400 text-sm leading-relaxed">
          ...
          <Card className="liquid-glass bg-white/5 backdrop-blur-sm border-white/10 hover:border-white/20 transition-all group stagger-item">
            <CardContent className="p-8 text-center">
              ...
              <h3 className="text-lg font-bold tracking-tight mb-3">Scale Yourself First</h3>
              <p className="text-slate-400 text-sm leading-relaxed">
          ...
          <Card className="liquid-glass bg-white/5 backdrop-blur-sm border-white/10 hover:border-white/20 transition-all group stagger-item">
            <CardContent className="p-8 text-center">
              ...
              <h3 className="text-lg font-bold tracking-tight mb-3">Continuous Innovation</h3>
              <p className="text-slate-400 text-sm leading-relaxed">
      ...
      {/* What Makes Us Different - Asymmetric Layout */}
      <section className="relative container mx-auto px-6 pb-24">
        <div className="max-w-4xl mx-auto text-center mb-16 stagger-item">
          <h2 className="text-3xl md:text-4xl font-bold tracking-tighter mb-4">What Makes Us Different</h2>
          <p className="text-xl text-slate-300">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          <Card className="liquid-glass bg-white/5 backdrop-blur-sm border-white/10 stagger-item">
            <CardContent className="p-8">
              ...
              <h3 className="text-xl font-bold tracking-tight mb-3">Battle-Tested by Founders in the Trenches</h3>
          ...
          <Card className="liquid-glass bg-white/5 backdrop-blur-sm border-white/10 stagger-item">
            <CardContent className="p-8">
              <div className="w-12 h-12 rounded-lg bg-emerald-600/20 flex items-center justify-center mb-6">
                <BarChart3 className="w-6 h-6 text-emerald-400" />
              </div>
              <h3 className="text-xl font-bold tracking-tight mb-3">The 7 Levels of Scale Framework</h3>
              <p className="text-slate-300 leading-relaxed">
          ...
          <Card className="liquid-glass bg-white/5 backdrop-blur-sm border-white/10 stagger-item">
            <CardContent className="p-8">
              ...
              <h3 className="text-xl font-bold tracking-tight mb-3">Break Through the Flatline</h3>
              <p className="text-slate-300 leading-relaxed">
      ...
      {/* By The Numbers - Asymmetric Layout */}
      <section className="relative container mx-auto px-6 pb-24">
        <div className="max-w-5xl mx-auto">
          <Card className="liquid-glass bg-gradient-to-br from-green-600/10 via-emerald-600/10 to-green-600/10 backdrop-blur-sm border-white/10 stagger-item">
            <CardContent className="p-12">
              <h2 className="text-2xl md:text-3xl font-bold tracking-tighter text-center mb-12">By the Numbers</h2>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                <div className="text-center stagger-item">
                  <div className="text-3xl md:text-4xl font-black text-white mb-2">91%</div>
                ...
                <div className="text-center stagger-item">
                  <div className="text-3xl md:text-4xl font-black text-green-400 mb-2">7</div>
                  <div className="text-slate-400 text-sm">Growth Levels</div>
                  <div className="text-slate-500 text-xs mt-1">From start to exit</div>
                </div>
                <div className="text-center stagger-item">
                  <div className="text-3xl md:text-4xl font-black text-emerald-400 mb-2">3</div>
      ...
      <section className="relative container mx-auto px-6 pb-24">
        <div className="max-w-4xl mx-auto">
          <Card className="liquid-glass bg-gradient-to-br from-green-600/20 to-emerald-600/20 backdrop-blur-sm border-white/10 overflow-hidden relative stagger-item">
            ...
            <CardContent className="relative p-12 md:p-16 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a href={GOOGLE_FORM_URL} target="_blank" rel="noopener noreferrer">
                  <Button size="lg" className="btn-interactive w-full sm:w-auto bg-green-600 hover:bg-green-500 text-white font-semibold shadow-lg">
                    Get Started Free
                    <ArrowRight className="ml-2 h-5 w-5" />
                  </Button>
                </a>
                <Link to="/product">
                  <Button size="lg" variant="outline" className="btn-interactive w-full sm:w-auto border-white/20 text-white hover:bg-white/10 font-semibold">
                    Explore Features
                  </Button>
                </Link>
              </div>
